...
public static class MessagingExtensions
{
    public static IServiceCollection AddMessaging(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        {
            services.AddSingleton<InMemoryAuditQueue>();
            services.AddSingleton<IAuditMessageSender>(sp => sp.GetRequiredService<InMemoryAuditQueue>());
            services.AddSingleton<IAuditMessageReceiver>(sp => sp.GetRequiredService<InMemoryAuditQueue>());
        }
