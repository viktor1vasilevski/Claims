...
public class ComputePremiumRequestValidatorTests
{
    private readonly ComputePremiumRequestValidator _sut = new();

    private ComputePremiumRequest ValidRequest() => new()
    {
